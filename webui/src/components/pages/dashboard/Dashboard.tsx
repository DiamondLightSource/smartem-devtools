        ...
        <Box sx={{ flex: 2, display: 'flex', flexDirection: 'column', gap: 1 }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'row', flex: 1, gap: 3 }}>
            ...
            <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 2.5 }}>
              ...
              <Box
                data-connection-id="aria-connector"
                ...
                <SystemComponentContainer heading="SmartEM Backend">
                  <Box sx={{ display: 'flex', flexDirection: 'row', flex: 1, gap: 1 }}>
                    ...
                    <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                      <Box
                        data-connection-id="smartem-backend-api"
                        sx={{ ...itemBoxSx, flex: 1, display: 'flex', alignItems: 'center' }}
                      >
                      ...
                      <Box
                        data-connection-id="smartem-agent-api"
                        sx={{ ...itemBoxSx, flex: 1, display: 'flex', alignItems: 'center' }}
                      >
                        <Typography variant="caption" sx={{ color: '#333' }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'row', gap: 1, alignItems: 'stretch' }}>
                <Box
                  data-connection-id="smartem-webui"
        ...
        <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 1 }}>
          <SystemComponentContainer heading="ARIA Depositions Backend">
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
              <Box
                data-connection-id="aria-graphql-api"
                sx={{
                  ...itemBoxSx,
                  display: 'flex',
                  alignItems: 'center',
              ...
              <Box sx={{ ...itemBoxSx, display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                ...
                >
                  Auth:{' '}
                  <Link
                    href="https://auth.aria.services/auth/realms/ARIA/protocol/openid-connect/auth"
                    target="_blank"
                    rel="noopener"
                  >
                  ...
                  Token:{' '}
                  <Link
                    href="https://auth.aria.services/auth/realms/ARIA/protocol/openid-connect/token"
                    target="_blank"
                    rel="noopener"
                  >
                ...
                >
                  Docs:{' '}
                  <Link href="https://beta.api.aria.services/" target="_blank" rel="noopener">
                    https://beta.api.aria.services/
                  </Link>
                  <br />
                  Endpoint:{' '}
                  <Link
                    href="https://graphql-beta.aria.services/graphql/"
                    target="_blank"
                    rel="noopener"
                  >
                  ...
                  <br />
                  Site:{' '}
                  <Link href="https://beta.structuralbiology.eu/" target="_blank" rel="noopener">
                    https://beta.structuralbiology.eu/
                  </Link>
                </Typography>
                ...
                >
                  Docs:{' '}
                  <Link href="https://api.aria.services/" target="_blank" rel="noopener">
                    https://api.aria.services/
                  </Link>
                  <br />
                  Endpoint:{' '}
                  <Link
                    href="https://graphql.aria.services/graphql/"
                    target="_blank"
                    rel="noopener"
                  >
                  ...
                  <br />
                  Site:{' '}
                  <Link href="https://instruct-eric.org/" target="_blank" rel="noopener">
