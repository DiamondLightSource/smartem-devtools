...
./scripts/k8s/generate-sealed-secrets.sh all
```
...
bash -x ./scripts/k8s/generate-sealed-secrets.sh development
...
```
├── scripts/k8s/generate-sealed-secrets.sh         # Main secret generation script
├── k8s/environments/
│   ├── development/
